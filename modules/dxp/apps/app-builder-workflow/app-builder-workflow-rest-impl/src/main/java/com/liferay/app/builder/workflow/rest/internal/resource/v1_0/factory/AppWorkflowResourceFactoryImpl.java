...
public class AppWorkflowResourceFactoryImpl
	...
	public AppWorkflowResource.Builder create() {
		return new AppWorkflowResource.Builder() {
			...
			@Override
			public AppWorkflowResource.Builder httpServletResponse(
	...
	private Object _invoke(
		...
		appWorkflowResource.setContextHttpServletResponse(httpServletResponse);
		appWorkflowResource.setContextUser(user);
		appWorkflowResource.setExpressionConvert(_expressionConvert);
		appWorkflowResource.setFilterParserProvider(_filterParserProvider);
		appWorkflowResource.setGroupLocalService(_groupLocalService);
		appWorkflowResource.setResourceActionLocalService(
			_resourceActionLocalService);
		appWorkflowResource.setResourcePermissionLocalService(
