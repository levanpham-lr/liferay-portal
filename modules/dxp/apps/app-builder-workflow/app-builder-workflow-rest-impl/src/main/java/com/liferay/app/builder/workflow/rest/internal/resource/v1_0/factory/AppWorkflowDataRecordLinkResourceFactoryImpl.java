...
public class AppWorkflowDataRecordLinkResourceFactoryImpl
	...
	public AppWorkflowDataRecordLinkResource.Builder create() {
		return new AppWorkflowDataRecordLinkResource.Builder() {
			...
			@Override
			public AppWorkflowDataRecordLinkResource.Builder
	...
	private Object _invoke(
		...
		appWorkflowDataRecordLinkResource.setExpressionConvert(
			_expressionConvert);
		appWorkflowDataRecordLinkResource.setFilterParserProvider(
			_filterParserProvider);
		appWorkflowDataRecordLinkResource.setGroupLocalService(
			_groupLocalService);
		appWorkflowDataRecordLinkResource.setResourceActionLocalService(
			_resourceActionLocalService);
		appWorkflowDataRecordLinkResource.setResourcePermissionLocalService(
