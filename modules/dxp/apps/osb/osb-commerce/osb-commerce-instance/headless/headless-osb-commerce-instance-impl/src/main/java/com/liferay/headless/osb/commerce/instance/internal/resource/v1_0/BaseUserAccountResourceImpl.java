...
public abstract class BaseUserAccountResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-osb-commerce-instance/v1.0/user-accounts/{portalInstanceId}/batch'  -u 'test@liferay.com:test'
	 */
	@Override
