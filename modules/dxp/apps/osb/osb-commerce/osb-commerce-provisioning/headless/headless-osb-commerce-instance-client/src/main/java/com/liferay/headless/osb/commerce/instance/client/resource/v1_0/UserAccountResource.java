...
package com.liferay.headless.osb.commerce.instance.client.resource.v1_0;

import com.liferay.headless.osb.commerce.instance.client.dto.v1_0.UserAccount;
import com.liferay.headless.osb.commerce.instance.client.http.HttpInvoker;
import com.liferay.headless.osb.commerce.instance.client.problem.Problem;
...
public interface UserAccountResource {
	...
	public static class UserAccountResourceImpl implements UserAccountResource {
		...
		public UserAccount postUserAccount(
			...
			try {
				return com.liferay.headless.osb.commerce.instance.client.serdes.
					v1_0.UserAccountSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse postUserAccountHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-osb-commerce-instance/v1.0/user-accounts/{portalInstanceId}",
				portalInstanceId);
		...
		public HttpInvoker.HttpResponse postUserAccountBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-osb-commerce-instance/v1.0/user-accounts/{portalInstanceId}/batch",
				portalInstanceId);
