...
public interface TodoListLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.alloy.mvc.sample.service.impl.TodoListLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the todo list local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TodoListLocalServiceUtil} if injection and service tracking are not available.
	 */
