...
public class AccountUserResourceFactoryImpl
	...
	public AccountUserResource.Builder create() {
		return new AccountUserResource.Builder() {
			...
			@Override
			public AccountUserResource.Builder httpServletResponse(
	...
	private Object _invoke(
		...
		accountUserResource.setContextHttpServletResponse(httpServletResponse);
		accountUserResource.setContextUser(user);
		accountUserResource.setExpressionConvert(_expressionConvert);
		accountUserResource.setFilterParserProvider(_filterParserProvider);
		accountUserResource.setGroupLocalService(_groupLocalService);
		accountUserResource.setResourceActionLocalService(
			_resourceActionLocalService);
		accountUserResource.setResourcePermissionLocalService(
