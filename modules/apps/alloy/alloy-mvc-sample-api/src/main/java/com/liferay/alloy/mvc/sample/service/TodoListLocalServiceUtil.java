 ...
 * <code>com.liferay.alloy.mvc.sample.service.impl.TodoListLocalServiceImpl</code> and
...
public class TodoListLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.alloy.mvc.sample.service.impl.TodoListLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TodoList createTodoList(long todoListId) {
		return getService().createTodoList(todoListId);
	}
	 ...
	 */
	public static TodoList deleteTodoList(long todoListId)
		throws PortalException {

		return getService().deleteTodoList(todoListId);
	}
	...
	public static TodoList fetchTodoList(long todoListId) {
		return getService().fetchTodoList(todoListId);
	}
	 ...
	 * @throws PortalException if a todo list with the primary key could not be found
	 */
	public static TodoList getTodoList(long todoListId) throws PortalException {
		return getService().getTodoList(todoListId);
	}
