...
/**
 * The base model implementation for the TodoList service. Represents a row in the &quot;AlloyMVCSample_TodoList&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TodoListModelImpl
	...
	public static final String ORDER_BY_JPQL =
		" ORDER BY todoList.todoListId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY AlloyMVCSample_TodoList.todoListId ASC";
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		com.liferay.alloy.mvc.sample.service.util.ServiceProps.get(
			"lock.expiration.time.com.liferay.alloy.mvc.sample.model.TodoList"));
	...
	private static Function<InvocationHandler, TodoList>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			TodoList.class.getClassLoader(), TodoList.class,
			ModelWrapper.class);

		try {
			Constructor<TodoList> constructor =
				(Constructor<TodoList>)proxyClass.getConstructor(
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(
			getCompanyId(), TodoList.class.getName(), getPrimaryKey());
	}
	...
	public CacheModel<TodoList> toCacheModel() {
		...
		todoListCacheModel.companyId = getCompanyId();

		todoListCacheModel.userId = getUserId();

		todoListCacheModel.userName = getUserName();

		String userName = todoListCacheModel.userName;

		if ((userName != null) && (userName.length() == 0)) {
			todoListCacheModel.userName = null;
		}
		...
		todoListCacheModel.name = getName();

		String name = todoListCacheModel.name;

		if ((name != null) && (name.length() == 0)) {
			todoListCacheModel.name = null;
		}
