 ...
 */
@Component(
	immediate = true, service = PriceModifierProductResource.Factory.class
)
@Generated("")
	...
	public PriceModifierProductResource.Builder create() {
		return new PriceModifierProductResource.Builder() {
			...
			public PriceModifierProductResource build() {
				...
				return (PriceModifierProductResource)ProxyUtil.newProxyInstance(
					PriceModifierProductResource.class.getClassLoader(),
					new Class<?>[] {PriceModifierProductResource.class},
